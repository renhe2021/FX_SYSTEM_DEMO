...
class FridayNightStrategy(BaseStrategy):
    ...
    交易时段：周五22:30开始，每半小时判断一次至周六01:30，周六02:00出场
    """
    
    name = "FridayNightStrategy"
    description = "周五夜盘策略：周五22:30起每半小时判断至01:30，周六02:00出场，捕捉周末效应"
    version = "2.0.0"
    author = "BMAD Team"
    ...
    def generate_signals(self, data: pd.DataFrame) -> List[Signal]:
        ...
        exit_day = self.params.get('exit_day', 5)
        exit_hour = self.params.get('exit_hour', 2)
